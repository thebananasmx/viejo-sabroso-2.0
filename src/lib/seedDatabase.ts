...
>[] = [
  ...
  },
  {
    ...
    description: "Chiles poblanos rellenos de queso, capeados y fritos",
    price: 110.0,
    category: "comida",
    available: true,
  },
  ...
  {
    name: "Refresco de Vidrio",
    description: "Coca-Cola de vidrio mexicana",
    price: 25.0,
    category: "bebidas",
    available: true,
  },
  ...
  },
  {
    ...
    description: "Gelatina de colores con leche condensada",
    price: 35.0,
    category: "postres",
    available: true,
  },
  ...
  try {
    ...
    for (const item of initialMenuItems) {
      try {
        ...
        console.error(`❌ Error agregando ${item.name}:`, error);
      }
    }

    console.log(`✅ Base de datos poblada exitosamente!`);
    console.log(
      `📊 Se agregaron ${successCount} de ${initialMenuItems.length} productos al menú`,
    );
  } catch (error) {
